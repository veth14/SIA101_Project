...
const ProfitTrendsChart = ({ className = "" }) => {
    ...
    return (_jsxs("div", { className: `overflow-hidden relative bg-white/95 backdrop-blur-2xl rounded-3xl border-white/60 shadow-2xl animate-fade-in ${className}`, children: [_jsx("div", { className: "absolute inset-0 transition-opacity duration-700 bg-gradient-to-br from-heritage-green/8 via-heritage-light/30 to-heritage-green/5 rounded-3xl opacity-60 group-hover:opacity-100" }), _jsxs("div", { className: "relative z-10", children: [_jsx("div", { className: "px-8 border-b py-7 bg-gradient-to-r from-white via-slate-50/80 to-white border-gray-200/30", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center space-x-5", children: [_jsxs("div", { className: "relative group", children: [_jsx("div", { className: "p-2 bg-[#82A33D]/10 rounded-xl", children: _jsx(TrendingUp, { className: "w-6 h-6 text-[#82A33D]" }) }), _jsx("div", { className: `absolute -inset-2 rounded-2xl blur-xl opacity-60 group-hover:opacity-100 transition-opacity duration-300 ${isProfitable
                                                    ...
                                                    ? 'text-white bg-gradient-to-r from-heritage-green to-heritage-neutral shadow-lg transform scale-105'
                                                    : 'text-gray-700 hover:text-heritage-green hover:bg-white/50'}`, onClick: () => setActiveTimeframe('yearly'), children: "Yearly" })] }) })] }) }), _jsxs("div", { className: "px-4 py-6", children: [_jsx("div", { className: "h-[320px] w-full", children: _jsx(RResponsiveContainer, { width: "100%", height: "100%", children: _jsxs(RAreaChart, { data: profitData, margin: { top: 20, right: 10, left: 10, bottom: 20 }, children: [_jsx("defs", { children: _jsxs("linearGradient", { id: "colorProfit", x1: "0", y1: "0", x2: "0", y2: "1", children: [_jsx("stop", { offset: "5%", stopColor: "#82A33D", stopOpacity: 0.8 }), _jsx("stop", { offset: "95%", stopColor: "#ABAD8A", stopOpacity: 0.1 })] }) }), _jsx(RXAxis, { dataKey: "period", tick: { fill: '#82A33D', fontSize: 12 }, axisLine: { stroke: '#82A33D', strokeWidth: 1 }, tickLine: false, interval: 0, padding: { left: 0, right: 0 } }), _jsx(RYAxis, { tickFormatter: formatShortCurrency, tick: { fill: '#82A33D', fontSize: 12 }, axisLine: false, tickLine: false }), _jsx(RCartesianGrid, { strokeDasharray: "3 3", vertical: false, stroke: "#ABAD8A" }), _jsx(RTooltip, { content: _jsx(CustomTooltip, {}) }), _jsx(RArea, { type: "linear", dataKey: "profit", stroke: "#82A33D", fillOpacity: 1, fill: "url(#colorProfit)", strokeWidth: 3, activeDot: {
                                                    r: 6,
                                                    stroke: '#ABAD8A',
                                                    strokeWidth: 2,
                                                    fill: 'white'
                                                } })] }) }) }), _jsx("div", { className: "flex items-center justify-center pb-2 mt-2", children: _jsxs("div", { className: "flex items-center gap-2 text-xs text-gray-600", children: [_jsx("div", { className: "w-3 h-0.5 bg-heritage-green rounded" }), _jsx("span", { className: "font-semibold", children: "Net Profit" })] }) })] }), _jsxs("div", { className: "grid grid-cols-1 gap-4 px-8 py-6 sm:grid-cols-2 md:grid-cols-4", children: [_jsxs("div", { className: "p-4 border shadow-sm bg-white/80 rounded-xl border-heritage-light", children: [_jsx("div", { className: "text-sm font-medium text-gray-500", children: "Total Profit" }), _jsx("div", { className: `text-2xl font-bold ${isProfitable ? 'text-heritage-green' : 'text-red-600'}`, children: formatCurrency(metrics.totalProfit) }), _jsxs("div", { className: `flex gap-1 items-center mt-1 text-xs font-medium ${isProfitable ? 'text-emerald-600' : 'text-red-600'}`, children: [_jsx("svg", { className: "w-3 h-3", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: isProfitable ? "M5 10l7-7m0 0l7 7m-7-7v18" : "M19 14l-7 7m0 0l-7-7m7 7V3" }) }), _jsxs("span", { children: [metrics.profitMargin.toFixed(1), "% margin"] })] })] }), _jsxs("div", { className: "p-4 border shadow-sm bg-white/80 rounded-xl border-heritage-light", children: [_jsx("div", { className: "text-sm font-medium text-gray-500", children: "Average Profit" }), _jsx("div", { className: "text-2xl font-bold text-heritage-green", children: formatCurrency(metrics.averageProfit) }), _jsxs("div", { className: "text-xs text-gray-500", children: ["Per ", activeTimeframe.slice(0, -2)] })] }), _jsxs("div", { className: "p-4 border shadow-sm bg-white/80 rounded-xl border-heritage-light", children: [_jsx("div", { className: "text-sm font-medium text-gray-500", children: "Best Period" }), _jsx("div", { className: "text-2xl font-bold text-heritage-green", children: formatCurrency(metrics.maxProfit) }), _jsx("div", { className: "text-xs text-gray-500", children: metrics.maxProfitPeriod })] }), _jsxs("div", { className: "p-4 border shadow-sm bg-white/80 rounded-xl border-heritage-light", children: [_jsx("div", { className: "text-sm font-medium text-gray-500", children: "Projected" }), _jsx("div", { className: "text-2xl font-bold text-heritage-green", children: formatCurrency(metrics.totalProfit * 1.08) }), _jsx("div", { className: "text-xs text-gray-500", children: "Next period" })] })] })] })] }));
};
