...
export const InvoicesPage = () => {
    ...
    const handleInvoiceCreated = (newInvoice) => {
        setInvoices(prevInvoices => {
            ...
            if (existingInvoice) {
                ...
                return prevInvoices.map(invoice => invoice.id === newInvoice.id ? newInvoice : invoice);
            }
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
      ...
      ` }), _jsxs("div", { className: "min-h-screen bg-[#F9F6EE]", children: [_jsxs("div", { className: "fixed inset-0 pointer-events-none", children: [_jsx("div", { className: "absolute rounded-full top-10 left-10 w-96 h-96 bg-gradient-to-r from-heritage-green/5 to-emerald-100/20 blur-3xl animate-pulse opacity-30" }), _jsx("div", { className: "absolute delay-1000 rounded-full opacity-25 top-32 right-16 w-80 h-80 bg-gradient-to-r from-blue-100/20 to-indigo-100/20 blur-3xl animate-pulse" }), _jsx("div", { className: "absolute rounded-full bottom-16 left-1/4 w-72 h-72 bg-gradient-to-r from-heritage-light/10 to-heritage-neutral/10 blur-3xl animate-pulse delay-2000 opacity-20" }), _jsx("div", { className: "absolute inset-0 opacity-5", children: _jsx("div", { className: "absolute inset-0", style: {
                                        backgroundImage: 'radial-gradient(circle at 25px 25px, rgba(134, 134, 134, 0.1) 1px, transparent 0)',
                                        backgroundSize: '50px 50px'
                                    } }) })] }), _jsxs("div", { className: "relative z-10 w-full px-4 py-4 space-y-6 lg:px-6", children: [_jsx(InvoiceStats, { invoices: invoices }), _jsx("div", { className: "w-full", children: _jsxs("div", { className: "grid grid-cols-1 gap-6 lg:grid-cols-3", children: [_jsx("div", { className: "lg:col-span-2", children: _jsx(InvoiceList, { invoices: invoices, onInvoiceSelect: handleInvoiceSelect, selectedInvoice: selectedInvoice, onInvoiceCreated: handleInvoiceCreated }) }), _jsx("div", { className: "lg:col-span-1", children: _jsx(InvoiceDetails, { invoice: selectedInvoice, onClose: () => setSelectedInvoice(null), onPrint: handlePrintInvoice }) })] }) })] }), isDetailsModalOpen && (_jsx(InvoiceDetails, { invoice: selectedInvoice, onClose: () => setIsDetailsModalOpen(false), onPrint: handlePrintInvoice })), _jsx(InvoiceSuccessModal, { isOpen: isSuccessModalOpen, onClose: handleSuccessModalClose, invoice: newlyCreatedInvoice })] })] }));
};
