      ...
      >
        <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden transform transition-all duration-300 animate-slideInUp border border-heritage-neutral/10">
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-160px)]">
            ...
            {/* Action Buttons */}
            <div className="flex justify-end gap-3 pt-6 mt-6 -mx-6 px-6 border-t border-gray-100 bg-gray-50/80">
              <button
                type="button"
                onClick={handleClose}
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-bold text-white rounded-lg shadow-md bg-gradient-to-r from-[#82A33D] to-emerald-600 hover:from-[#6d8735] hover:to-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isCreating ? (
                  <>
