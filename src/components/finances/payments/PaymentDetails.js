...
const PaymentDetails = ({ payment, onClose, onPrint }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `@keyframes slide-in-right {
        ...
        .payment-items-scroll::-webkit-scrollbar-thumb:hover { background: rgba(130, 163, 61, 0.5); }` }), _jsx("div", { className: "h-full min-h-0 p-5 border shadow-2xl bg-white/70 backdrop-blur-2xl rounded-3xl border-heritage-neutral/20 animate-slide-in-right", children: _jsxs("div", { className: "flex flex-col h-full", children: [_jsx("div", { className: "p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 via-white to-gray-50", children: _jsx("div", { className: "flex items-center justify-between mb-2", children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "p-2 bg-[#82A33D]/10 rounded-xl", children: _jsx("svg", { className: "w-6 h-6 text-[#82A33D]", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" }) }) }), _jsxs("div", { children: [_jsx("h3", { className: "text-2xl font-black text-gray-900", children: "Payment Details" }), _jsxs("p", { className: "flex items-center gap-2 mt-1 text-sm text-gray-600", children: [_jsxs("span", { className: "inline-flex items-center px-2 py-1 bg-[#82A33D]/10 text-[#82A33D] rounded-lg text-xs font-semibold", children: ["#", payment.id] }), _jsx("span", { className: "text-gray-400", children: "\u2022" }), _jsx("span", { className: "truncate max-w-[320px]", children: payment.guestName })] })] })] }) }) }), _jsxs("div", { className: "flex-1 px-6 pt-5 pb-4 space-y-5 overflow-y-auto payment-items-scroll", children: [_jsx("div", { children: _jsxs("div", { className: "p-4 rounded-2xl bg-gradient-to-r from-[#82A33D]/8 via-white to-emerald-50 border border-[#82A33D]/18 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-3", children: [_jsxs("div", { children: [_jsx("p", { className: "text-[11px] font-semibold tracking-wide text-gray-500 uppercase", children: "Total Amount" }), _jsx("p", { className: "mt-1 text-[26px] leading-tight font-extrabold text-gray-900", children: formatCurrency(payment.amount) })] }), _jsxs("div", { className: "flex flex-col items-start md:items-end gap-1.5 text-xs", children: [_jsx("span", { className: "inline-flex items-center px-3 py-1 text-[11px] font-semibold rounded-full bg-[#111827] text-white tracking-wide shadow-sm", children: payment.status.toUpperCase() }), _jsxs("span", { className: "text-[11px] text-gray-500", children: [payment.transactionDate, " \u2022 ", payment.transactionTime] })] })] }) }), _jsxs("div", { className: "grid gap-5 md:grid-cols-2 items-stretch", children: [_jsxs("div", { className: "space-y-3 h-full", children: [_jsx("h4", { className: "text-[11px] font-bold tracking-wide text-gray-500 uppercase", children: "Guest Information" }), _jsxs("div", { className: "p-4 space-y-3 bg-white border border-gray-100 rounded-2xl shadow-sm h-full flex flex-col justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-[11px] font-semibold text-gray-500", children: "Guest Name" }), _jsx("p", { className: "mt-0.5 text-sm font-semibold text-gray-900", children: payment.guestName })] }), _jsxs("div", { children: [_jsx("p", { className: "text-[11px] font-semibold text-gray-500", children: "Room" }), _jsxs("p", { className: "mt-0.5 text-sm text-gray-900", children: ["Room ", payment.roomNumber] })] }), _jsxs("div", { children: [_jsx("p", { className: "text-[11px] font-semibold text-gray-500", children: "Reference" }), _jsx("p", { className: "mt-0.5 text-[11px] font-mono text-gray-800 break-all", children: payment.reference })] })] })] }), _jsxs("div", { className: "space-y-3 h-full", children: [_jsx("h4", { className: "text-[11px] font-bold tracking-wide text-gray-500 uppercase", children: "Transaction Details" }), _jsxs("div", { className: "p-4 space-y-4 bg-white border border-gray-100 rounded-2xl shadow-sm h-full flex flex-col justify-between", children: [_jsxs("div", { children: [_jsx("p", { className: "text-[11px] font-semibold text-gray-500", children: "Description" }), _jsx("p", { className: "mt-0.5 text-sm text-gray-900", children: payment.description })] }), _jsxs("div", { children: [_jsx("p", { className: "text-[11px] font-semibold text-gray-500 mb-2", children: "Payment Method" }), _jsxs("div", { className: `flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-semibold ${methodInfo.color}`, children: [_jsx("span", { className: `text-lg ${methodInfo.iconColor}`, children: methodInfo.icon }), _jsx("span", { children: methodInfo.name })] }), _jsx("ul", { className: "mt-2 space-y-1 text-[11px] text-gray-600 list-disc list-inside", children: methodInfo.details.map((d, idx) => (_jsx("li", { children: d }, idx))) })] })] })] })] })] }), _jsx("div", { className: "p-4 border-t border-gray-200 bg-gradient-to-r from-gray-50/50 via-white to-gray-50/50", children: _jsxs("div", { className: "grid grid-cols-2 gap-3", children: [_jsxs("button", { onClick: handlePrint, className: "flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-heritage-green to-heritage-neutral text-white rounded-xl hover:from-heritage-green hover:to-heritage-neutral transition-all shadow-md hover:shadow-lg transform hover:scale-[1.02] group text-sm font-semibold", children: [_jsx("svg", { className: "w-4 h-4 transition-transform group-hover:scale-110", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2z" }) }), _jsx("span", { children: "Print Receipt" })] }), _jsxs("button", { onClick: handleDownload, className: "flex items-center justify-center space-x-2 px-4 py-3 bg-white border-2 border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm hover:shadow-md transform hover:scale-[1.02] group text-sm font-semibold", children: [_jsx("svg", { className: "w-4 h-4 transition-transform group-hover:scale-110", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" }) }), _jsx("span", { children: "Download PDF" })] })] }) })] }) })] }));
};
