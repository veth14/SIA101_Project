            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-4">
                  <div>
                    <h1 className="text-5xl font-black text-[#82A33D] drop-shadow-sm">Revenue Tracking</h1>
                    <p className="text-xl text-gray-700 font-medium tracking-wide">Monitor revenue streams and analyze performance trends</p>
                  </div>

                  {/* Net Profit Pill (compact) */}
                  {/* compact header area (no inline profit action) */}
                ...
                <div className="flex items-center space-x-4 mt-4">
                  <div className="flex items-center space-x-2 bg-emerald-50 backdrop-blur-sm rounded-full px-4 py-2 border border-emerald-200">
                    ...
                    <span className="text-sm font-semibold text-emerald-700">Revenue stream active</span>
                  </div>
                  <div className="flex items-center space-x-2 bg-blue-50 backdrop-blur-sm rounded-full px-4 py-2 border border-blue-200">
                    ...
                    <span className="text-sm font-medium text-blue-700">{new Date().toLocaleDateString('en-US', { weekday: 'long', month: 'short', day: 'numeric' })}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              <div className="bg-gradient-to-br from-white/90 to-green-500/5 backdrop-blur-xl rounded-3xl p-8 border border-green-500/20 shadow-xl group-hover:scale-105 transition-all duration-500">
                ...
                <div className="relative">
                  ...
                  <p className="text-gray-700 mt-2 font-semibold tracking-wide">Live Tracking</p>
