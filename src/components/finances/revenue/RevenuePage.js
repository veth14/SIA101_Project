...
export const RevenuePage = () => {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-[#F9F6EE]", children: [_jsxs("div", { className: "fixed inset-0 pointer-events-none", children: [_jsx("div", { className: "absolute rounded-full top-10 left-10 w-96 h-96 bg-gradient-to-r from-heritage-green/5 to-emerald-100/20 blur-3xl opacity-30" }), _jsx("div", { className: "absolute delay-1000 rounded-full opacity-25 top-32 right-16 w-80 h-80 bg-gradient-to-r from-blue-100/20 to-indigo-100/20 blur-3xl" }), _jsx("div", { className: "absolute rounded-full bottom-16 left-1/4 w-72 h-72 bg-gradient-to-r from-heritage-light/10 to-heritage-neutral/10 blur-3xl delay-2000 opacity-20" }), _jsx("div", { className: "absolute inset-0 opacity-5", children: _jsx("div", { className: "absolute inset-0", style: {
                                ...
                                backgroundSize: '50px 50px'
                                        ...
                                        } }), _jsxs("div", { role: "tablist", "aria-label": "Revenue tabs", className: "relative z-10 flex items-center justify-center w-full gap-3", children: [_jsx("button", { role: "tab", "aria-selected": activeTab === 'revenue', tabIndex: 0, onClick: () => {
                                                    setActiveTab('revenue');
                                                    navigate(location.pathname, { replace: false });
                                                }, className: `group z-20 flex items-center justify-center flex-1 text-center px-10 py-3.5 text-[15px] font-bold rounded-2xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-300/50 leading-tight ${activeTab === 'revenue'
                                                    ? 'text-emerald-900 scale-[1.02]'
                                                    : 'text-emerald-700/80 hover:text-emerald-800 hover:scale-[1.01]'}`, children: _jsx("span", { className: "font-extrabold tracking-wide", children: "Revenue" }) }), _jsx("button", { role: "tab", "aria-selected": activeTab === 'profit', tabIndex: 0, onClick: () => {
                                                    setActiveTab('profit');
                                                    // deep-link the profit tab so layout/topbar can detect it
                                                    navigate(`${location.pathname}?tab=profit`, { replace: false });
                                                }, title: "Net profit and margin analytics", className: `group z-20 flex items-center justify-center flex-1 text-center px-10 py-3.5 text-[15px] font-bold rounded-2xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-emerald-300/50 leading-tight ${activeTab === 'profit'
                                                    ? 'text-emerald-900 scale-[1.02]'
                                                    : 'text-emerald-700/80 hover:text-emerald-800 hover:scale-[1.01]'}`, children: _jsx("span", { className: "font-extrabold tracking-wide", children: "Profit & Margin" }) })] })] }) }) }), _jsxs("div", { children: [activeTab === 'revenue' && (_jsx(RevenueDashboard, {})), activeTab === 'profit' && (_jsx(Suspense, { fallback: null, children: _jsxs("div", { className: "space-y-6", children: [_jsx(OverviewCards, { totalRevenue: metrics.totalRevenue, totalExpenses: metrics.totalExpenses, netProfit: metrics.totalProfit }), _jsx(ProfitAnalysisCharts, { costAnalysis: costAnalysis, departmentProfits: departmentProfits })] }) }))] })] })] }));
};
