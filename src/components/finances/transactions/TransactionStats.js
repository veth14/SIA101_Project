...
const TransactionStats = ({ totalTransactions, completedTransactions, pendingTransactions, isLoading }) => {
    ...
    const stats = [
        ...
        },
        {
            ...
            icon: (_jsx("svg", { className: "w-6 h-6 text-orange-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" }) }))
        }
    ];
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
      ...
      ` }), _jsx("div", { className: "grid grid-cols-1 gap-6 mb-8 md:grid-cols-3", children: stats.map((stat, index) => (_jsxs("div", { className: "overflow-hidden relative p-8 rounded-2xl border shadow-lg backdrop-blur-xl transition-all duration-500 bg-white/95 border-white/50 hover:shadow-2xl hover:-translate-y-1 group animate-slide-up-fade", style: {
