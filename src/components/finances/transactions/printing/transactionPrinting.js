...
export const printTransactionReceipt = (transaction) => {
    const receiptHTML = `
      <div style="
    ...
    let printDiv = document.querySelector('#print-content');
    if (!printDiv) {
...
export const downloadTransactionReceiptPdf = async (transaction) => {
