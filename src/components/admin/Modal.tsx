  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={handleBackdropClick}>
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between p-0 border-b border-heritage-neutral/10 bg-gradient-to-r from-heritage-green/5 to-heritage-light/10 backdrop-blur-sm rounded-t-2xl">
          {headerContent ? (
            headerContent
          ) : (
            <>
