...
export const LostFoundNavigation = ({ activeTab, onTabChange }) => {
    const tabs = [
        {
            id: 'found',
            label: 'Found Items',
            description: 'Items reported as found',
            icon: (_jsxs("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: [_jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 8c-1.657 0-3 1.567-3 3.5S10.343 15 12 15s3-1.567 3-3.5S13.657 8 12 8z" }), _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 3v2m0 14v2m8.485-8.485h-2M5.515 12H3.515m13.07-6.364l-1.414 1.414M7.343 16.657l-1.414 1.414M16.657 16.657l1.414 1.414M7.343 7.343L5.929 5.929" })] })),
        ...
        },
        {
            ...
            icon: (_jsxs("svg", { className: "w-5 h-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: [_jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 2l3 7h-6l3-7z" }), _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M5 20h14a1 1 0 001-1v-2a6 6 0 00-6-6H10a6 6 0 00-6 6v2a1 1 0 001 1z" })] })),
    ...
    return (_jsx("div", { className: "bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden", children: _jsx("div", { className: "p-6", children: _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: tabs.map((tab) => (_jsxs("button", { onClick: () => onTabChange(tab.id), className: `relative group p-6 rounded-2xl border-2 transition-all duration-300 hover:scale-105 hover:shadow-lg ${activeTab === tab.id
