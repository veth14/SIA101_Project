...
const LeaveRequestDetailsModal: React.FC<Props> = ({ isOpen, onClose, leaveRequest }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center px-4 bg-black/40 backdrop-blur-md">
        <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-hidden animate-slide-in-up">
          
          {/* Header - Cleaner style matching Edit Payroll */}
