...
const CreateLeaveRequestModal: React.FC<Props> = ({ 
  ...
  const modalContent = (
    ...
    >
      <div className="relative z-10 w-full max-w-4xl rounded-3xl bg-white/95 shadow-2xl border border-white/60 max-h-[90vh] overflow-hidden">
        {/* Header - matching CreateScheduleModal / ItemDetailsModal style */}
