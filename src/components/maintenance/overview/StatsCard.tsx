      ...
      <div className="relative flex items-start justify-between">
        ...
        <div className="flex-1 mr-5">
          <div className="flex items-center mb-3">
            ...
            <p className="text-sm font-bold tracking-wide text-gray-700">{title}</p>
          </div>
          
          <div className="relative">
            <p className="mb-3 text-4xl font-extrabold text-[#82A33D] group-hover:scale-105 transition-transform duration-300">{value}</p>
          ...
          {badge && (
            <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 border border-emerald-200/50">
        ...
        {/* Right side - icon */}
        <div className="relative">
          <div className={`w-16 h-16 ${iconBg} rounded-xl flex items-center justify-center shadow-md border border-white/70 group-hover:shadow-lg group-hover:scale-105 transition-all duration-300`}>
            {icon}
