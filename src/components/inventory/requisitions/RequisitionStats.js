...
export const RequisitionStats = ({ stats, formatCurrency }) => {
    const statCards = [
        {
            ...
            changeType: 'positive',
            iconBg: 'bg-blue-100',
            icon: (_jsx("svg", { className: "w-6 h-6 text-blue-600", fill: "currentColor", viewBox: "0 0 20 20", children: _jsx("path", { fillRule: "evenodd", d: "M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z", clipRule: "evenodd" }) }))
        },
        {
