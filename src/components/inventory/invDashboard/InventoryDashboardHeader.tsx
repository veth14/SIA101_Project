/**
 * InventoryDashboardHeader Component
 * 
 * A beautiful glassmorphism header component for the Inventory Dashboard page.
...
/**
 * Header component for Inventory Dashboard page with glassmorphism design
 */
const InventoryDashboardHeader: React.FC = () => {
  return (
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xl text-gray-700 font-medium tracking-wide">
                  Overview of inventory metrics and performance
                </p>
