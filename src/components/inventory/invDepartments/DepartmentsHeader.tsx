/**
 * DepartmentsHeader Component
 * 
 * A beautiful glassmorphism header component for the Departments page.
...
/**
 * Header component for Departments page with glassmorphism design
 */
const DepartmentsHeader: React.FC = () => {
  return (
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xl text-gray-700 font-medium tracking-wide">
                  Manage department-wise inventory allocation
                </p>
                ...
                <div className="flex items-center space-x-4 mt-4">
                  <div className="flex items-center space-x-2 bg-emerald-50 backdrop-blur-sm rounded-full px-4 py-2 border border-emerald-200">
                    ...
                    <span className="text-sm font-semibold text-emerald-700">Budgets tracked</span>
                  </div>
