...
export const UltraPremiumDepartmentCards: React.FC<UltraPremiumDepartmentCardsProps> = ({
  departments,
  formatCurrency,
}) => {
  return (
      ...
      {departments.map((dept, index) => (
        ...
        >
          ...
          <div className="relative z-10 flex items-start justify-between mb-8">
            <div className="flex-1">
              <div className="flex items-center space-x-3 mb-2">
                ...
                <h3 className="text-2xl font-black text-gray-900 tracking-tight">{dept.name}</h3>
              </div>
              <div className="flex items-center space-x-2">
                <svg className="w-4 h-4 text-heritage-neutral" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
                <p className="text-sm font-medium text-heritage-neutral">{dept.manager}</p>
              </div>
            </div>
          ...
          <div className="relative z-10 grid grid-cols-2 gap-6 mb-8">
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-50/80 via-blue-100/60 to-indigo-100/80 backdrop-blur-sm rounded-2xl p-5 border border-blue-200/50 group-hover:shadow-lg transition-all duration-300">
              ...
              <div className="relative">
                ...
                <p className="text-3xl font-black text-blue-700 mb-1">{dept.itemsAssigned}</p>
                <p className="text-xs font-bold text-blue-600 uppercase tracking-wider">Items Assigned</p>
              </div>
            </div>
            <div className="relative overflow-hidden bg-gradient-to-br from-emerald-50/80 via-emerald-100/60 to-green-100/80 backdrop-blur-sm rounded-2xl p-5 border border-emerald-200/50 group-hover:shadow-lg transition-all duration-300">
              ...
              <div className="relative">
                ...
                <p className="text-3xl font-black text-emerald-700 mb-1">{dept.totalUsage}%</p>
                <p className="text-xs font-bold text-emerald-600 uppercase tracking-wider">Total Usage</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-heritage-light/30 to-white/50 backdrop-blur-sm rounded-2xl p-6 border border-heritage-neutral/20">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-sm font-bold text-gray-800">Monthly Consumption</p>
                </div>
                <div className="text-right">
                  <p className="text-lg font-black text-heritage-green">{formatCurrency(dept.monthlyConsumption)}</p>
                  <p className="text-xs text-heritage-neutral font-medium">Current Month</p>
                </div>
              </div>
              <div className="relative">
                ...
                <div className="flex justify-between text-xs font-medium text-gray-600 mt-2">
                  <span>0%</span>
                  <span className="text-heritage-green font-bold">{dept.totalUsage}%</span>
                  <span>100%</span>
                </div>
              </div>
            </div>
          ...
          <div className="relative z-10 flex space-x-3">
            <button className="flex-1 group/btn relative overflow-hidden px-5 py-3 text-sm font-bold text-white bg-gradient-to-r from-heritage-green to-emerald-600 rounded-xl shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
            ...
            <button className="flex-1 px-5 py-3 text-sm font-bold text-blue-700 bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl hover:from-blue-100 hover:to-blue-200 hover:shadow-lg transition-all duration-300">
            ...
            <button className="px-5 py-3 text-sm font-bold text-gray-700 bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 rounded-xl hover:from-gray-100 hover:to-gray-200 hover:shadow-lg transition-all duration-300">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
