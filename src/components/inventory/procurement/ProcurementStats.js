...
const getIconConfig = (title) => {
    switch (title) {
        ...
        case 'Vendor Performance':
            return {
                icon: (_jsx("svg", { className: "w-6 h-6 text-purple-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 10V3L4 14h7v7l9-11h-7z" }) })),
...
export const ProcurementStats = ({ stats, formatCurrency }) => {
    const [statCards, setStatCards] = useState([]);
    const { getInvProcurementStats, loadingForGetInvProcurementStats, } = useGetInvProcurement();
    useEffect(() => {
