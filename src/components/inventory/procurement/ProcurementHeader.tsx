/**
 * ProcurementHeader Component
 * 
 * A beautiful glassmorphism header component for the Procurement page.
...
/**
 * Header component for Procurement page with glassmorphism design
 */
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-4 mt-4">
                  <div className="flex items-center space-x-2 bg-emerald-50 backdrop-blur-sm rounded-full px-4 py-2 border border-emerald-200">
                    ...
                    <span className="text-sm font-semibold text-emerald-700">Orders processing</span>
                  </div>
