/**
 * InventoryItemsHeader Component
 * 
 * A beautiful glassmorphism header component for the Inventory Items page.
...
/**
 * Header component for Inventory Items page with glassmorphism design
 */
const InventoryItemsHeader: React.FC = () => {
  return (
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center space-x-4 mt-4">
                  <div className="flex items-center space-x-2 bg-emerald-50 backdrop-blur-sm rounded-full px-4 py-2 border border-emerald-200">
                    ...
                    <span className="text-sm font-semibold text-emerald-700">Stock levels monitored</span>
                  </div>
