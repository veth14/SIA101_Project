...
const ItemDetailsModal: React.FC<ItemDetailsModalProps> = ({
  ...
  const modalContent = (
    ...
    >
      ...
      >
        <div
          className="relative w-full max-w-5xl max-h-[90vh] bg-white rounded-2xl shadow-2xl transform transition-all overflow-hidden"
          style={{ zIndex: 99999 }}
        >
          {/* Header */}
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/60 p-5">
                    ...
                    <div className="space-y-3">
                      {recentActivity.slice(0, 4).map((activity) => (
                        <div
                          key={activity.id}
                          className="flex items-center space-x-3 p-3 bg-gradient-to-r from-gray-50 to-white rounded-lg hover:shadow-sm transition-all duration-200"
                        >
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        ...
                        <p className="text-sm font-medium text-yellow-900">
                          Increase reorder level to 25 units
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>
                        <p className="text-sm font-medium text-yellow-900">
                          Reorder in 12 days to avoid stockout
                        </p>
                      </div>
                      <div className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2M7 4h10M7 4l-1 16h12L17 4M10 8v8M14 8v8"
                      />
                    </svg>
                    Adjust Stock
                  </button>
              ...
              {adjustmentQuantity && (
                <div className="p-3 bg-blue-50 rounded-lg">
                  <p className="text-sm text-blue-800">
                    <strong>Preview:</strong> {item.currentStock}{" "}
