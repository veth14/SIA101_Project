...
export const ItemsStats = ({ items, formatCurrency, }) => {
    ...
    const stats = [
        ...
        },
        {
            ...
            changeType: "negative",
            iconBg: "bg-red-100",
            icon: (_jsx("svg", { className: "w-6 h-6 text-red-600", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728L5.636 5.636m12.728 12.728L18.364 5.636M5.636 18.364l12.728-12.728" }) })),
        },
        {
