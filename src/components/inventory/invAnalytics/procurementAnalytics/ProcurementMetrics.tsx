...
const ProcurementMetrics: React.FC = () => {
  const { getInvProcurementMetrics, loadingForGetInvProcurementMetrics } =
    useGetInvAnalytic();
  useEffect(() => {
    const useGetInvAnalyticFunc = async () => {
      ...
      const iconMap: Record<string, JSX.Element> = {
        ...
        Lightbulb: <Lightbulb className="w-6 h-6 text-blue-600" />,
        Zap: <Zap className="w-6 h-6 text-purple-600" />,
        BarChart: <BarChart className="w-6 h-6 text-amber-600" />,
      };
