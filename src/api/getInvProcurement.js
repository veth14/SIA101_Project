...
const useGetInvProcurement = () => {
    const [loadingForGetInvProcurementOrder, setLoadingForGetInvProcurementOrder] = useState(false);
    const [loadingForGetInvProcurementStats, setLoadingForGetInvProcurementStats] = useState(false);
