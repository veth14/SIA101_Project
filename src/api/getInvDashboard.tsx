...
const useGetInvDashboard = () => {
  const [loadingForGetInvDashboard, setLoadingForGetInvDashboard] =
    useState(false);
  const [loadingForGetInvDashboardChart, setLoadingForGetInvDashboardChart] =
    useState(false);
  const [loadingForGetInvDashboardActivity, setLoadingForGetInvDashboardActivity] =
    useState(false);
