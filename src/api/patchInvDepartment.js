...
const usePatchInvDepartment = () => {
    ...
    const patchInvMaintenanceRequest = async (id, dataToUpdate) => {
        try {
            ...
            const response = await axios.patch(`/inventory-department/update-maintenance-request/${encodedId}`, dataToUpdate);
