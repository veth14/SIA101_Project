...
const useGetInvAnalytic = () => {
  ...
  const [
    ...
    setLoadingForGetInvProcurementMetrics,
  ] = useState(false);
  const [
    loadingForGetInvProcurementAnalytics,
    setLoadingForGetInvProcurementAnalytics,
  ] = useState(false);
  const [
    loadingForGetInvDepartmentMetrics,
    setLoadingForGetInvDepartmentMetrics,
  ] = useState(false);
  const [
    loadingForGetInvDepartmentCharts,
    setLoadingForGetInvDepartmentCharts,
  ] = useState(false);
  ...
  const getInvProcurementMetrics = async () => {
    try {
      ...
      const response = await axios.get(
        "/inventory-analytic/get-procurement-metrics"
      );
      return response.data;
    } catch (error: any) {
      console.log(error);
  ...
  const getInvProcurementAnalytics = async () => {
    try {
      ...
      const response = await axios.get(
        "/inventory-analytic/get-procurement-analytics"
      );
      return response.data;
    } catch (error: any) {
      console.log(error);
  ...
  const getInvDepartmentMetrics = async () => {
    try {
      ...
      const response = await axios.get(
        "/inventory-analytic/get-department-metrics"
      );
      return response.data;
    } catch (error: any) {
      console.log(error);
  ...
  const getInvDepartmentCharts = async () => {
    try {
      ...
      const response = await axios.get(
        "/inventory-analytic/get-department-charts"
      );
      return response.data;
    } catch (error: any) {
      console.log(error);
