    ...
    <div className="min-h-screen bg-[#F9F6EE]">
      ...
      <div className="relative z-10 w-full px-2 py-4 space-y-6 sm:px-4 lg:px-6">
        ...
        {selectedFolder ? (
          ...
          <div className="relative w-full overflow-hidden bg-gradient-to-br from-white via-white to-heritage-light/30 backdrop-blur-xl rounded-3xl border-2 border-white/60 shadow-2xl p-10">
            {/* Decorative Elements */}
          ...
          <div className="relative w-full overflow-hidden bg-gradient-to-br from-white via-white to-heritage-light/30 backdrop-blur-xl rounded-3xl border-2 border-white/60 shadow-2xl hover:shadow-3xl transition-all duration-500 p-10">
            {/* Decorative Elements */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-heritage-green/5 to-transparent rounded-full -translate-y-1/2 translate-x-1/2"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-tr from-heritage-neutral/5 to-transparent rounded-full translate-y-1/2 -translate-x-1/2"></div>
