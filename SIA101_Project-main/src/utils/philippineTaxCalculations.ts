 ...
 */
export const calculateSSS = (monthlySalary: number): { employee: number; employer: number; total: number } => {
  // 2025 SSS Contribution Table (Semi-monthly basis, so divide monthly by 2)
  const semiMonthly = monthlySalary / 2;
  
  if (semiMonthly < 3250) return { employee: 135, employer: 315, total: 450 };
  if (semiMonthly < 3750) return { employee: 157.50, employer: 367.50, total: 525 };
  if (semiMonthly < 4250) return { employee: 180, employer: 420, total: 600 };
  if (semiMonthly < 4750) return { employee: 202.50, employer: 472.50, total: 675 };
  if (semiMonthly < 5250) return { employee: 225, employer: 525, total: 750 };
  if (semiMonthly < 5750) return { employee: 247.50, employer: 577.50, total: 825 };
  if (semiMonthly < 6250) return { employee: 270, employer: 630, total: 900 };
  if (semiMonthly < 6750) return { employee: 292.50, employer: 682.50, total: 975 };
  if (semiMonthly < 7250) return { employee: 315, employer: 735, total: 1050 };
  if (semiMonthly < 7750) return { employee: 337.50, employer: 787.50, total: 1125 };
  if (semiMonthly < 8250) return { employee: 360, employer: 840, total: 1200 };
  if (semiMonthly < 8750) return { employee: 382.50, employer: 892.50, total: 1275 };
  if (semiMonthly < 9250) return { employee: 405, employer: 945, total: 1350 };
  if (semiMonthly < 9750) return { employee: 427.50, employer: 997.50, total: 1425 };
  if (semiMonthly < 10250) return { employee: 450, employer: 1050, total: 1500 };
  if (semiMonthly < 10750) return { employee: 472.50, employer: 1102.50, total: 1575 };
  if (semiMonthly < 11250) return { employee: 495, employer: 1155, total: 1650 };
  if (semiMonthly < 11750) return { employee: 517.50, employer: 1207.50, total: 1725 };
  if (semiMonthly < 12250) return { employee: 540, employer: 1260, total: 1800 };
  if (semiMonthly < 12750) return { employee: 562.50, employer: 1312.50, total: 1875 };
  if (semiMonthly < 13250) return { employee: 585, employer: 1365, total: 1950 };
  if (semiMonthly < 13750) return { employee: 607.50, employer: 1417.50, total: 2025 };
  if (semiMonthly < 14250) return { employee: 630, employer: 1470, total: 2100 };
  if (semiMonthly < 14750) return { employee: 652.50, employer: 1522.50, total: 2175 };
  if (semiMonthly < 15250) return { employee: 675, employer: 1575, total: 2250 };
  if (semiMonthly < 15750) return { employee: 697.50, employer: 1627.50, total: 2325 };
  if (semiMonthly < 16250) return { employee: 720, employer: 1680, total: 2400 };
  if (semiMonthly < 16750) return { employee: 742.50, employer: 1732.50, total: 2475 };
  if (semiMonthly < 17250) return { employee: 765, employer: 1785, total: 2550 };
  if (semiMonthly < 17750) return { employee: 787.50, employer: 1837.50, total: 2625 };
  if (semiMonthly < 18250) return { employee: 810, employer: 1890, total: 2700 };
  if (semiMonthly < 18750) return { employee: 832.50, employer: 1942.50, total: 2775 };
  if (semiMonthly < 19250) return { employee: 855, employer: 1995, total: 2850 };
  if (semiMonthly < 19750) return { employee: 877.50, employer: 2047.50, total: 2925 };
 ...
 */
export const calculatePhilHealth = (monthlySalary: number): { employee: number; employer: number; total: number } => {
 ...
 */
export const calculatePagIBIG = (monthlySalary: number): { employee: number; employer: number; total: number } => {
 ...
 */
export const calculateWithholdingTax = (monthlyTaxableIncome: number): number => {
