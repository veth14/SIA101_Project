...
router.get("/get-analytics-bottom-section",analyticController.getAnalyticsBottomSection);
router.get("/get-procurement-metrics",analyticController.getProcurementMetrics);
router.get("/get-procurement-analytics",analyticController.getProcurementAnalytics);
